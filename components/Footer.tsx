        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 md:gap-8 mb-6 text-center md:text-left">
          ...
          <div>
            ...
            <div className="flex space-x-3 justify-center md:justify-start">
              <a href="#" aria-label="Instagram" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-gray-400 hover:text-white hover:bg-primary-600 hover:scale-110 transition-all">
              ...
              <a href="#" aria-label="YouTube" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-gray-400 hover:text-white hover:bg-primary-600 hover:scale-110 transition-all">

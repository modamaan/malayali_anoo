            ...
            <div className="flex flex-col gap-2 mb-2">
              <div className="flex items-center">
                <span className="text-xs font-bold text-zinc-400 uppercase tracking-wider">
                  Color {selectedColor && (
                    <span className="text-zinc-900 ml-2 capitalize font-medium">
                      : {selectedColor.includes('|') ? selectedColor.split('|')[1] || 'Custom' : (
                        {
                          '#000000': 'Black', '#ffffff': 'White', '#ff0000': 'Red', 
                          '#00ff00': 'Green', '#0000ff': 'Blue', '#ffff00': 'Yellow',
                          '#800080': 'Purple', '#ffa500': 'Orange', '#808080': 'Grey', '#c0c0c0': 'Silver'
                        }[selectedColor.toLowerCase()] || 'Custom'
                      )}
                    </span>
                  )}
                </span>
              ...
              <div className="flex flex-wrap gap-2">
                {product.colors.map(colorStr => {
                  ...
                  if (colorStr.includes('|')) {
                    ...
                    name = defaults[colorStr.toLowerCase()] || 'Custom'
                  }
                  ...
                  return (
                    <button
                      ...
                      className={`w-8 h-8 rounded-full border-2 transition-all flex items-center justify-center shrink-0 ${selectedColor === colorStr ? 'border-primary-500 scale-110 shadow-md ring-2 ring-primary-500/20' : 'border-zinc-200 scale-100 hover:scale-110'}`}

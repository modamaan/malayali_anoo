          ...
          <div className="space-y-12">
            ...
            <div>
              ...
              <div className="flex space-x-4">
                <a href="#" aria-label="Instagram" className="w-14 h-14 rounded-full bg-white/5 hover:bg-primary-600 flex items-center justify-center text-white hover:scale-110 transition-all">
                ...
                <a href="#" aria-label="YouTube" className="w-14 h-14 rounded-full bg-white/5 hover:bg-primary-600 flex items-center justify-center text-white hover:scale-110 transition-all">
                ...
                <a href="#" aria-label="TikTok" className="w-14 h-14 rounded-full bg-white/5 hover:bg-primary-600 flex items-center justify-center text-white hover:scale-110 transition-all">
